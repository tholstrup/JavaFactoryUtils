...
/**
 * Represents the parameter types and parameters for a method or constructor. It simply holds parameter types and parameters and implements
 * the equals and hashCode methods so that methods or constructors with the same method/constructor signature will equate. This class is
 * immutable.
 */
public class MethodSignature
{
    ...
    {
        // You might worry about integer overflow here but it is ok... jvm spec does not throw an error it just drops off the most
        // significant
